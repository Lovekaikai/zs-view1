    ...
    <page-content name="完善商家资料">
      <div class="content">
        <div class="content-item">
          ...
          <!-- 企业官网、网址 -->
          <div class="content-item-item">
            <div class="item-title"><span style="color: red">*</span>{{$t('merchant.merchantWebsiten')}}</div>
            <div class="item-input" style="width: 80%">
          ...
          <!-- 企业品牌 -->
          <div class="content-item-item">
            <div class="item-title"><span style="color: red">*</span>{{$t('merchant.merchantBrand')}}</div>
